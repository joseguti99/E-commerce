            ...
            <div class="conntainer-fluid">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 col-sm-12 col-lg-5">
                        ...
                        <div class="col-12 col-sm-12 text-center"><button class="btn btn-primary btn-lg" data-bs-dismiss="modal" onclick="agregarAlCarrito('${producto.titulo}'), contadorCarrito()"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cart3" viewBox="0 0 16 16">
