...
<div class="modal-content">
    <div class="modal-body">
        <div class="conntainer-fluid">
            ...
            <div class="row">
                <div class="col-7 col-sm-12 col-lg-7 text-center">
                ...
                <div class="col-5 col-sm-12 col-lg-5">
                    ...
                    <div class="col-12 col-sm-12"><button class="btn btn-primary btn-lg" data-bs-dismiss="modal" onclick="agregarAlCarrito('${producto.titulo}'), contadorCarrito()"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cart3" viewBox="0 0 16 16">
            ...
            <div class="row">
                <div class="text-center"><img src="./img/enviosgratis.png" class="col-2 col-sm-5 col-md-5 col-lg-2 col-xl-2 col-xxl-2"></div>
            </div>
            </div>
        </div>
    </div>
